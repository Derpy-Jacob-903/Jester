...
public class DivineProtection() : JesterCard(2, CardType.Power,
    CardRarity.Rare, TargetType.AnyAlly)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        ..MakeCalculatedVar("isAlpha", 1, (c, creature) => c.CombatState.Allies.Any(p => p.HasPower<AlphaPower>()) ? 2 : 1),
        new PowerVar<AutopilotNextTurnPower>(1)
    ];
